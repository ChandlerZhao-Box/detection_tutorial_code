...
def _main_(args):
    ...
    while video_capture.isOpened():
        ...
        cv2.putText(img, 'yolo ftps: %2f' % (1 / (end - start)), (40, 40), cv2.FONT_HERSHEY_TRIPLEX, 0.5, (0, 0, 255),
                    0, True)
        cv2.imshow("Detection", (img).astype('uint8'))
    ...
    # cv2.imwrite('yolo_result.jpg', (image).astype('uint8'))
